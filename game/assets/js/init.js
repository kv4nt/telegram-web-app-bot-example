...
function createPhysicBall(_0x39cdx15, _0x39cdx16, _0x39cdx17) {
    ballPhysics_arr.push({
        ...
        body: "",
        material: "",
        property: {radius: _0x39cdx15 / scaleX},
        position: [0, 0]
    });
...
function renderPhysics() {
    for (var _0x39cdx8 = 0; _0x39cdx8 < gameData.ballArray.length; _0x39cdx8++) {
        var _0x39cdx16 = ballPhysics_arr[_0x39cdx8].body.position[0],
            _0x39cdx17 = ballPhysics_arr[_0x39cdx8].body.position[1];
...
var guideline, bg, logo, buttonStart, buttonRestart, buttonFacebook, buttonTwitter, buttonWhatsapp, buttonFullscreen,
...
var textDisplay = {
    ...
    chanceInsufficient: "НЕ ХВАТАЕТ МОНЕТ\"",
    won: "ВЫИГРЫШ [NUMBER]!",
    lose: "БЕЗ ВЫИГРЫША",
    playing: "МЯЧИКИ ПАДАЮТ...",
    playingMultiple: "МЯЧИ ПАДАЮТ... ([NUMBER] ОСТАЛОСЬ)",
    gameOver: "КОНЕЦ ИГРЫ",
    collectPrize: "[NUMBER]",
    exitTitle: "ВЫХОД",
...
function animatePin(_0x39cdx1b) {
    ...
    var _0x39cdxe3 = 0.3;
    TweenMax.to(_0x39cdxe2, _0x39cdxe3, {
        scaleX: 2, scaleY: 2, alpha: 0.5, overwrite: true, onComplete: function () {
...
function resizeGameLayout() {
    ...
    var _0x39cdx69 = {
        ...
        scaleY: 1,
        w: gameData.boardW,
        h: gameSettings.board.size * (gameData.totalRows + 1),
        maxW: 1e3,
        maxH: 510,
        scalePercentX: 1,
        scalePercentY: 1
    ...
    ;
    TweenMax.to(plinkoContainer, 0.2, {
        x: _0x39cdx69.x,
        y: _0x39cdx69.y,
        scaleX: _0x39cdx69.scaleX,
        scaleY: _0x39cdx69.scaleY,
        overwrite: true
    });
    positionWinHistory();
}
...
function startAnimate(_0x39cdxb9) {
    TweenMax.to(_0x39cdxb9, _0x39cdxb9.tween.startSpeed, {
        delay: _0x39cdxb9.tween.startDelay,
        alpha: _0x39cdxb9.tween.startAlpha,
        overwrite: true,
        onComplete: function () {
            TweenMax.to(_0x39cdxb9, _0x39cdxb9.tween.endSpeed, {
                delay: _0x39cdxb9.tween.endDelay,
                alpha: _0x39cdxb9.tween.endAlpha,
                overwrite: true,
                onComplete: function () {
...
function toggleGameStatus(_0x39cdxee, _0x39cdxef) {
    ...
    if (_0x39cdxee != undefined) {
        ...
        if (!isNaN(_0x39cdxef)) {
            TweenMax.to(statusTxt, _0x39cdxef, {
                doverwrite: true, onComplete: function () {
                    displayGameStatusAmount();
                }
            });
        }
...
function loopDropBalls() {
    ...
    TweenMax.to(gameData, _0x39cdx102, {
...
function findMovePath(_0x39cdx24, _0x39cdx113) {
    ...
    _0x39cdx24.finalMoveArray.push({
        x: _0x39cdx117[_0x39cdx113 + "_" + _0x39cdx118].x,
        y: _0x39cdx117[_0x39cdx113 + "_" + _0x39cdx118].y
    });
    if (_0x39cdx113 == gameData.totalRows) {
        ...
        _0x39cdx24.finalMoveArray.push({
            x: _0x39cdx117[_0x39cdx113 + "_" + _0x39cdx118].x,
            y: _0x39cdx117[_0x39cdx113 + "_" + _0x39cdx118].y + (_0x39cdx126 - (_0x39cdx125 + _0x39cdx116))
        });
    }
}
...
function startBallMove(_0x39cdx24) {
    if (_0x39cdx24.moveIndex == _0x39cdx24.finalMoveArray.length - 1 || _0x39cdx24.moveIndex == 0) {
        ...
        TweenMax.to(_0x39cdx24, 0.5, {
            x: _0x39cdx24.finalMoveArray[_0x39cdx24.moveIndex].x,
            y: _0x39cdx24.finalMoveArray[_0x39cdx24.moveIndex].y,
            ease: Bounce.easeOut,
            overwrite: true,
            onComplete: ballMoveComplete,
            onCompleteParams: [_0x39cdx24]
        });
    } else {
        var _0x39cdx128 = [{x: _0x39cdx24.x, y: _0x39cdx24.y}, {
            x: _0x39cdx24.finalMoveArray[_0x39cdx24.moveIndex].x,
            y: _0x39cdx24.finalMoveArray[_0x39cdx24.moveIndex].y - gameSettings.board.size * 1.3
        }, {
            x: _0x39cdx24.finalMoveArray[_0x39cdx24.moveIndex].x,
            y: _0x39cdx24.finalMoveArray[_0x39cdx24.moveIndex].y - gameSettings.board.size * 0.2
        }, {
            x: _0x39cdx24.finalMoveArray[_0x39cdx24.moveIndex].x,
            y: _0x39cdx24.finalMoveArray[_0x39cdx24.moveIndex].y
        }];
        var _0x39cdx129 = Math.floor(Math.random() * 3 + 3) * 0.1;
        TweenMax.to(_0x39cdx24, _0x39cdx129, {
            bezier: {type: "cubic", values: _0x39cdx128},
            ease: Circ.easeIn,
            overwrite: true,
            onComplete: ballMoveComplete,
            onCompleteParams: [_0x39cdx24]
...
function animateHistory(_0x39cdxb9) {
    var _0x39cdxe3 = 0.2;
    TweenMax.to(_0x39cdxb9, _0x39cdxe3, {
        scaleX: 1.2, scaleY: 1.2, alpha: 1, ease: Sine.easeIn, onComplete: function () {
            TweenMax.to(_0x39cdxb9, _0x39cdxe3, {
                scaleX: 1, scaleY: 1, ease: Sine.easeOut, onComplete: function () {
                }
            });
        }
    });
...
function animatePrize(_0x39cdxb9) {
    var _0x39cdxe3 = 0.2;
    TweenMax.to(_0x39cdxb9, _0x39cdxe3, {
        y: _0x39cdxb9.oriY + gameSettings.board.size / 3, ease: Sine.easeIn, overwrite: true, onComplete: function () {
            TweenMax.to(_0x39cdxb9, _0x39cdxe3, {
                y: _0x39cdxb9.oriY,
                ease: Sine.easeOut,
                overwrite: true,
    ...
    var _0x39cdxe3 = 0.2;
    TweenMax.to(_0x39cdxb9.bgWin, _0x39cdxe3, {
        alpha: 1, ease: Sine.easeIn, overwrite: true, onComplete: function () {
            TweenMax.to(_0x39cdxb9.bgWin, _0x39cdxe3, {
                delay: _0x39cdxe3,
                alpha: 0,
                ease: Sine.easeOut,
