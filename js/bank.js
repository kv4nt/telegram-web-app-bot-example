...
function reloadall() {
    ...
    document.getElementById("level").innerHTML =
        "Лапки <i class=\"fa-solid fa-paw text-success\"></i>: " + addcomma(upown);
...
function upgrade(name) {
    if (name == "upgrade") {
        ...
        if (money >= upcost) {
            ...
            document.getElementById("level").innerHTML = "Лапки <i class=\"fa-solid fa-paw text-success\"></i>: " + addcomma(upown);
            //checkDiscount(0);
