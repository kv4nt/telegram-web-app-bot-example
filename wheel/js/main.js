...
window.RuntimeInterface = class a {
    ...
    async _Init(b) {
        "macos-wkwebview" === this._exportType ? this._SendWrapperMessage({
            type: "ready"
        }) : this.IsWebView2Wrapper() && (this._SetupWebView2Polyfills(),
    ...
    _OnWrapperMessage(b) {
        if ("entered-fullscreen" === b)
            ...
            const c = b.type;
            "wrapper-init-response" === c ? (this._wrapperInitResolve(b),
                this._wrapperInitResolve = null) : "extension-message" === c ? this.PostToRuntimeComponent("runtime", "wrapper-extension-message", b) : console.warn("Unknown wrapper message: ", b)
        } else
...
window.C3_IsSupported && (window.c3_runtimeInterface = new self.RuntimeInterface({
    useWorker: !0,
    workerMainUrl: "js/workermain.js",
    engineScripts: ["js/c3runtime.js"],
    projectScripts: [],
    mainProjectScript: "",
    scriptFolder: "js/",
